...
<div class="main-header">
    ...
    <p>Tác giả:  Nguyễn Thị Thanh Thuỷ - Trường  Tiểu học  - ĐT: 0886696988</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Thanh Thuỷ - Trường  Tiểu học Hùng An - ĐT: 0886696988</div>", unsafe_allow_html=True)
